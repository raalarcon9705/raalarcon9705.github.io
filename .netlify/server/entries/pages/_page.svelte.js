...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header><div class="container"><nav><a href="/" class="brand">Reynier Rivero</a>
      <ul class="${["nav-list sections", ""].join(" ").trim()}"><li><a href="#resume">Resume</a></li>
...
const experience = [
  {
    ...
    until: "Present",
    annotations: [
      "MakerDAO Informational Site Optimizations.",
      "Develop of several components, pipes and services for the website of MakerDAO.",
      "Development of automated tests for the MakerDAO website.",
      "Refactored and improved the performance and code quality of the ReMake project."
    ]
  },
  {
    position: "Web Developer",
    company: "Boukker Technologies Inc.",
    from: "Jun 2018",
    until: "Jan 2022",
    annotations: [
      "Created a Landing Page for the tool using Bootstrap 5.",
      "Improved user experience by implementing a PWA, which increased return rate by 57%.",
      "Facilitated an efficient SSR with Angular Universal and ExpressJs, which improved the position in search results by 43%.",
      "Implemented a simple and efficient online rich text editor, with a nice and responsive interface, increasing the number of daily posts by 24%."
    ]
  },
  {
    position: "Frontend Developer",
    company: "ElroiSupplies",
    from: "Apr 2020",
    until: "Oct 2020",
    annotations: [
      "Created an e-commerce using shopify's graphql api.",
      "Innovated a CMS-style e-commerce template generator, using Angular.",
      "Developed a PWA for improvement the user experience in the store."
    ]
  }
];
const education = [
  {
    ...
    university: "UCI, Havana",
    from: "Sep 2016",
    until: "Dec 2021",
    annotations: [
      "Recognition for participation in the ICPC",
      "Development of a blog to share good practices among the developers of the University of Informatics Sciences",
      "Contributions in the different projects of the Medical Informatics Center of the University"
    ]
  }
];
const projects = [
  "https://www.biprintzble.com",
  "https://123regenrinnefrei.de",
  "https://www.lorca.ai",
  "http://www.puertoricococina.com:3001",
  "https://plaza274.netlify.app",
  "https://mips.makerdao.com",
  "https://www.remake.video"
];
...
const Study = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<h4 class="timeline-title">${escape(data.from)} - ${escape(data.until)}</h4>
<div class="timeline-text"><span class="title">${escape(data.title)}
		<span>${escape(data.university)}</span></span>
	<ul>${each(data.annotations, (note) => {
...
const Work = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<h4 class="timeline-title">${escape(data.from)} - ${escape(data.until)}</h4>
<div class="timeline-text"><span class="title">${escape(data.position)}
		<span>${escape(data.company)}</span></span>
	<ul>${each(data.annotations, (note) => {
    return `<li>${escape(note)}</li>`;
  })}</ul></div>`;
});
const Resume = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section class="section" id="resume"><div class="section-content"><div class="container"><div class="section-header"><h4 class="section-subtitle">I&#39;m available for hire</h4>
			...
			<div class="d-flex wrap"><div class="expand-md"><h3 class="box-text">Education</h3>
					<ul class="timeline">${each(education, (study) => {
    return `<li class="timeline-item">${validate_component(Study, "Study").$$render($$result, { data: study }, {}, {})}
							</li>`;
  })}</ul></div>
				<div class="expand-md"><h3 class="box-text">Work Experience</h3>
					<ul class="timeline">${each(experience, (work) => {
    return `<li class="timeline-item">${validate_component(Work, "Work").$$render($$result, { data: work }, {}, {})}
							</li>`;
  })}</ul></div></div>
    ...
    return `${validate_component(Skill, "Skill").$$render($$result, { skill: skill.skill, value: skill.value }, {}, {})}`;
					...
					<ul class="link-list">${each(projects, (url) => {
    return `<li><a target="_blank" rel="noreferrer"${add_attribute("href", url, 0)}>${escape(url)}</a>
							</li>`;
...
<main>${validate_component(Home, "Home").$$render($$result, {}, {}, {})}
	...
	<a href="#!" class="close-section">×</a></main>
